...
/**
 * Created by 10714 on 2018/4/2.
 */

public class SendMsgWeb  extends AppCompatActivity {
        ...
        findViewById(R.id.button_submit_publish).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("".equals(mTitleEdit.getText().toString())) {
                    Toast.makeText(SendMsgWeb.this, "请输入标题", Toast.LENGTH_SHORT).show();
                    return;
                }
                if ("".equals(mDiscriptionEdit.getText().toString())) {
                    Toast.makeText(SendMsgWeb.this, "请输入商品描述", Toast.LENGTH_SHORT).show();
                    return;
                }
                if ("".equals(mPriceEdit.getText().toString())) {
                    Toast.makeText(SendMsgWeb.this, "请输入金额", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (mImageBytes == null) {
                    Toast.makeText(SendMsgWeb.this, "请选择一张照片", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                product.saveInBackground(new SaveCallback() {
                    ...
                    public void done(AVException e) {
                        if (e == null) {
                            ...
                            SendMsgWeb.this.finish();
                        } else {
                            mProgerss.setVisibility(View.GONE);
                            Toast.makeText(SendMsgWeb.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
