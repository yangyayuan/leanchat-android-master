...
//      .build();
//
//  public static DisplayImageOptions avatarGroupImageOptions = new DisplayImageOptions.Builder()
//  .showImageOnLoading(R.drawable.group_icon)
//  .showImageForEmptyUri(R.drawable.group_icon)
//  .showImageOnFail(R.drawable.group_icon)
//  .cacheInMemory(true)
//  .cacheOnDisc(true)
//  .considerExifParams(true)
//  .imageScaleType(ImageScaleType.EXACTLY)
...
//  .build();
//
//  public static DisplayImageOptions avatarGatheringImageOptions = new DisplayImageOptions.Builder()
//  .showImageOnLoading(R.drawable.gathering_icon)
//  .showImageForEmptyUri(R.drawable.gathering_icon)
//  .showImageOnFail(R.drawable.gathering_icon)
//  .cacheInMemory(true)
//  .cacheOnDisc(true)
//  .considerExifParams(true)
//  .imageScaleType(ImageScaleType.EXACTLY)
