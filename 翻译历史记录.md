...
```
horizontal:水平;
美式：['hɔrə'zɑntl];英式：[hɒrɪ'zɒnt(ə)l];
n. 水平线，水平面；水平位置
adj. 水平的；地平线的；同一阶层的
网络释义：
Horizontal : 水平,横向,卧式,
horizontal merger : 横向兼并,横向合并,横向兼井,
HORIZONTAL SUBSYSTEM : 水平布线子系统,水平区子系统,水平子系统,
```
- alignment
```
alignment:对齐;
美式：[ə'laɪnmənt];英式：[ə'laɪnm(ə)nt];
n. 队列，成直线；校准；结盟
网络释义：
Alignment : 对齐,阵营 (龙与地下城),对准,
optical alignment : 光学对准,光学准直,光学调准,
alignment chart : 列线图,诺模图,线算图,
```
- vertical
```
vertical:垂直;
美式：['vɝtɪkl];英式：['vɜːtɪk(ə)l];
n. 垂直线，垂直面
adj. 垂直的，直立的；[解剖] 头顶的，顶点的
网络释义：
Vertical : 垂直,立式的,弹跳,
Vertical angles : 对顶角,对顶角,垂直角,
Flip Vertical : 垂直翻转,垂直方向翻转,垂直反转,
```
- relative
```
relative:相对;
美式：['rɛlətɪv];英式：['relətɪv];
n. 亲戚；相关物；[语] 关系词；亲缘植物
adj. 相对的；有关系的；成比例的
网络释义：
Relative : 亲戚,亲属,相对的,
Relative risk : 相对风险,相对风险,相对危险度,
relative motion : 相对运动,相对移动,相对活动,
```
- below
```
below:下面;
